...
var serverAddress="http://52.5.33.235";
var port=5003;
...
server.get('/', function(req, res) {
   // client.lpush("myPages",req.url)
    res.send('Welcome to Server_3, Port is 5001')
...
setInterval( function () 
{
	...
	{ 
		name: "Your Computer", cpu: cpuAverage(), memoryLoad: memoryLoad(), testResult: testResult(),
        nodes: calcuateColor()
   });
