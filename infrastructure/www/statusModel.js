...
var ClientModel = function(client)
{
    ...
    self.testResult = ko.observable(client.testResult);
...
[
    { 
	    name: "Fake Client", cpu: "39.95", memoryLoad: "40", testResult: "50",
        nodes: 
        [
            {color:"#00ff00"},
            {color:"#cccc00"},
    ...
    { 
	    name: "Your Computer", cpu: "0.00", memoryLoad: "0", testResult: "0",
        nodes: 
        [
            {color:"#ab3fdd"},
            {color:"#ab3fdd"},
